...
// Define blood types as a valid enum
const bloodTypes = ["A", "B", "AB", "O"] as const;

// Refactor schema for cleaner validation
const schema = z.object({
    ...
    bloodType: z.enum(bloodTypes, {message: "Select a valid blood type!"}),
    ...
    return (
        <form className="flex flex-col gap-8" onSubmit={onSubmit}>
            ...
            <div className="flex justify-between flex-wrap gap-4">
                ...
                {/* Blood Type dropdown with real blood types */}
                <div className="flex flex-col gap-2 w-full md:w-1/4">
                    <label className="text-xs text-gray-500">Blood Type</label>
                    <select
                        className="ring-[1.5px] ring-gray-300 p-2 rounded-md text-sm w-full" {...register("bloodType")}
                ...
                <InputField label="Birthday" name="birthday" type="date" defaultValue={data?.birthday}
